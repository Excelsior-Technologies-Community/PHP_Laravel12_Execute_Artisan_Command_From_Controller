...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Keep Artisan output dark when hovering */
        .output-row:hover td {
        ...
        <div class="stats">
            ...
            <div class="stat-card">
                ...
                <div class="stat-value">
                    {{ $averageDuration ? number_format($averageDuration, 2) . ' ms' : '0 ms' }}
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span
                                    class="status {{ $history->status === 'success' ? 'status-success' : 'status-failed' }}">
